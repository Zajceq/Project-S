...
public class ShipMovement : MonoBehaviour
{
    ...
    {
        Vector2 screenBounds = Camera.main.ScreenToWorldPoint(new Vector3(Screen.width, Screen.height, transform.position.z + Mathf.Abs(transform.position.z - Camera.main.transform.position.z)));
